...
- Usage: Reference from command with `@/Users/potts/Claude Projects/clinicaltocode/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/potts/Claude Projects/clinicaltocode/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/potts/Claude Projects/clinicaltocode/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
