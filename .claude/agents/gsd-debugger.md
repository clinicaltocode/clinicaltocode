...
```bash
INIT=$(node "/Users/potts/Claude Projects/clinicaltocode/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/potts/Claude Projects/clinicaltocode/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/potts/Claude Projects/clinicaltocode/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
